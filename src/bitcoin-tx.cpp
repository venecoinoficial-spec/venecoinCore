...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s venecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  venecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded venecoin transaction") + "\n" +
              "  venecoin-tx [options] -create [commands]   " + _("Create hex-encoded venecoin transaction") + "\n" +
              "\n";
