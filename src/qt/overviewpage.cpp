...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the venecoin Core repository on GitHub"),
        tr("Services that claim to double your venecoins are always ponzi schemes")
    };
