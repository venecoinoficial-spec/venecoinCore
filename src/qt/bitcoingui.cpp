...
// Copyright (c) 2021-2023 The venecoin Core developers
    ...
    platformStyle(_platformStyle)
{
...
#endif
    // venecoin: título personalizado requerido por el usuario
    const QString kCustomBanner = QStringLiteral("Venecoin Oficial v2.0.0.1 - Red Privada");
    setWindowTitle(kCustomBanner);
    ...
    // venecoin: load fallback font in case Comic Sans is not available on the system
    ...
    // venecoin: load this bundled font for Settings -> Options in case it's not available on the system
    ...
    // venecoin: Specify Comic Sans as new font.
    QFont newFont("Comic Sans MS", 10);

    // venecoin: Set new application font
    ...
    // venecoin: insertar banner permanente a la izquierda de la barra de estado
    QLabel* bannerLabel = new QLabel(kCustomBanner);
    bannerLabel->setObjectName("vc_bannerLabel");
    bannerLabel->setStyleSheet("QLabel#vc_bannerLabel { background-color: #f7d7a7; color: #000; padding: 4px 8px; font-weight: bold; border: 1px solid #e0b97a; border-radius: 2px; }");
    statusBar()->insertPermanentWidget(0, bannerLabel, 1);
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a venecoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and venecoin: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your venecoin addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified venecoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a venecoin: URI or payment request"));

    importPrivateKeyAction = new QAction(platformStyle->TextColorIcon(":/icons/address-book"), tr("&Import Private Key..."), this);
    importPrivateKeyAction->setStatusTip(tr("Import a venecoin private key"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible venecoin command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        tooltip = tr("%n active connection(s) to venecoin network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("venecoin"); // default title
