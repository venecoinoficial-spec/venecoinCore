...
#define QAPP_ORG_NAME "venecoin"
#define QAPP_ORG_DOMAIN "venecoin.org"
#define QAPP_APP_NAME_DEFAULT "venecoin-Qt"
#define QAPP_APP_NAME_TESTNET "venecoin-Qt-testnet"
