...
const char * const BITCOIN_CONF_FILENAME = "venecoin.conf";
const char * const BITCOIN_PID_FILENAME = "venecoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "venecoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/venecoin";
#else
    // Unix
    return pathRet / ".venecoin";
#endif
#endif
}
