...
/** Recommended transaction fee by venecoin Core developers
  *
 ...
 *
 *  venecoin:    Increment mempool limits and accept RBF in steps of 0.0001 DOGE
...
/**
 * venecoin: Default dust limit that is evaluated when considering whether a
...
/**
 * venecoin: Default hard dust limit that is evaluated when considering whether
