...
if 'ENABLE_WALLET' not in vars():
    ENABLE_WALLET=0
if 'ENABLE_venecoinD' not in vars():
    ENABLE_venecoinD=0
...
#Set env vars
if "venecoinD" not in os.environ:
    os.environ["venecoinD"] = BUILDDIR + '/src/venecoind' + EXEEXT
...
if not (ENABLE_WALLET == 1 and ENABLE_UTILS == 1 and ENABLE_venecoinD == 1):
    print("No rpc tests to run. Wallet, utils, and venecoind must all be enabled")
    sys.exit(0)
...
class RPCTestHandler:
    ...
    def __init__(self, num_tests_parallel, test_list=None, flags=None):
        ...
        self.flags = flags
        self.num_running = 0
        # In case there is a graveyard of zombie venecoinds, we can apply a
...
class RPCCoverage(object):
    ...
    commands per `venecoin-cli help` (`rpc_interface.txt`).
