venecoin Core version 1.14.5 is now available from:

  <https://github.com/venecoin/venecoin/releases/tag/v1.14.5/>

This is a new minor version release, including important security updates and
changes to network policies. All venecoin Core users, miners, services, relay
...
To receive security and update notifications, please watch reddit or Twitter:
  ...
  * https://www.reddit.com/r/venecoindev/
  * @venecoin on Twitter for high priority announcements
  * @venecoin\_devs on Twitter for updates on development work

Compatibility
==============

venecoin Core is extensively tested on Ubuntu Server LTS, Intel-based macOS
and Windows 10.

venecoin Core should also work on most other Unix-like systems but is not
...
most venecoin Core users.

### Remote Code Execution in venecoin QT (CVE-2021-3401)
...
**venecoin QT users are urged to please update their installations to this
...
leakage of sensitive information when venecoin Core crashes on Unix platforms.
The vulnerability is patched for systems that run a Linux kernel equal to or
higher than 3.4.

**venecoin Core wallet users on Linux platforms are urged to please update to
this version.**
...
the venecoin network, following the reduction of relay and mining defaults in
...
* The user interface for selecting fees when transacting DOGE has been updated
  ...
  venecoin blocks are not full, typically all transactions are mined in the next
  block, and therefore the target estimation does not makes sense for venecoin.
...
The Berkley DB version used by venecoin Core has been updated to 5.3 (from 5.1)
...
performance of cryptographic routines within venecoin Core.
