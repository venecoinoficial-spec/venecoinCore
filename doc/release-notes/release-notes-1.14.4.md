venecoin Core version 1.14.4 is now available from:

  <https://github.com/venecoin/venecoin/releases/tag/v1.14.4/>
...
operators to agree on fees regardless of defaults coded into the venecoin Core
...
* The default setting shipped with venecoin core for relay fee has been reduced
